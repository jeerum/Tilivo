...
- Cookie: `mrjkp_session`, `HttpOnly`, `SameSite=Lax`, `Path=/`; `Secure` lülitatakse sisse
...
- CSRF: **double-submit** mudel.
  - Teine cookie `mrjkp_csrf` (mitte HttpOnly, sest JS peab seda lugema) sisaldab juhuslikku tokenit;
