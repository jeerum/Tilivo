...
Current release work: v0.15 Time Tracking. See [`docs/TIME_TRACKING.md`](docs/TIME_TRACKING.md), [`docs/EMPLOYEE_REGISTRY.md`](docs/EMPLOYEE_REGISTRY.md) and [`docs/BANKING.md`](docs/BANKING.md).
