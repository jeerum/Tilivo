...
## Praegune seis (v0.12 Sales Ledger 2.0)
...
`20260908000000_ai_classification_v11`; v0.12 lisab
`20260909000000_sales_ledger_v12` ja
`20260909010000_sales_ledger_payment_update`. `remote-deploy.sh` teeb kõik
automaatselt:
